...
export default function UnfinishedSessionDialog({ session, onContinue, onComplete, onDiscard, onClose }) {
        ...
        {!showCompleteForm ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => onComplete(completedDate, parseInt(durationMinutes) || 0)}
                disabled={!durationMinutes}
                className="flex-1 glass px-4 py-3 rounded-xl text-white font-light hover:glass-strong transition-all duration-300 disabled:opacity-50"
              >
                Complete
              </button>
            </div>
